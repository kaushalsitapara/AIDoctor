...
public class translReqEngGuj extends AsyncTask<Object,Integer,Bundle> {
...
*/
  ...
  /*          Object sz = trans(objects[0].toString());
            ...
            o1 = sz;*/
            {
                String url = "https://api.mymemory.translated.net/get?q=" + s1 + "&langpair=en|gu";
...

            {
                ...
                String url = "https://transapi.herokuapp.com/guj";
